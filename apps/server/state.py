...
class TelegramBotProto(Protocol):
    """Telegram bot interface (admin-only, mixin-composed)."""
    ...
    async def on_trade_executed(self, report: Any) -> None: ...
    async def on_trade_execution_failed(self, report: Any) -> None: ...
    async def on_position_closed(self, report: Any) -> None: ...
    async def on_trade_failure(self, license_key: str, error: str) -> None: ...
